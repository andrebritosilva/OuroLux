...
//TRCell():New(oSection ,"FILIAL"    ,,"Fl"					,,02,,,			,,"LEFT") 
...
If MV_PAR03 = 1// 1 = Saida
	...
	//cQuery += "        AND SB8.B8_SERIE IN ('003','099') "
	...
	While SD2NF->(!Eof())
		...
		//oSection:Cell("FILIAL"	):SetValue(SD2NF->D2_FILIAL)
		...
		If Empty(SD2NF->B8_SERIE)
			...
			cQuery += "        AND SD1.D1_LOTECTL = SD3.D3_LOTECTL "
			...
			oSection:Cell("NFENT"	):SetValue(SD3NF->D1_DOC + "-" + SD3NF->D1_SERIE)
		...
		oSection:Cell("LOTE"	):SetValue(AllTrim(SD2NF->B8_LOTECTL))
